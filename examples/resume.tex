...
\name{Michael}{Theocharis}
\position{Front-End Engineer}
\address{Thessaloniki, Greece}

\mobile{+30 6977 149230}
%\whatsapp{(+82) 10-9030-1843}
\email{michaeltheochar@gmail.com}
%\dateofbirth{January 1st, 1970}
\github{michaeltheo}
\linkedin{michael-theocharis}
% \gitlab{gitlab-id}
...
\quote{Front-end engineer focused on building reliable, maintainable products with React and TypeScript.}
